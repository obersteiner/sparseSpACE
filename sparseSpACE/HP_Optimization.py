...
def perform_GO_classification(data, lambd_levels):
...
def perform_BO_classification(data, amt_it: int, function = perform_evaluation_at, space = classification_space, ev_is_rand: bool = True):
...
perform_evaluation_at(data_moons, 0.828603059876013, 0, 2, 1)
